...
<template>
  <div class="gen-form">
    <p class="text-secondary" style="font-size: var(--fs-caption); max-width: 520px;">
      Time-ordered 128-bit identifier — UUIDv7. The first 48 bits encode a Unix millisecond timestamp,
      so values sort chronologically — better for database primary keys than v4.
    </p>
